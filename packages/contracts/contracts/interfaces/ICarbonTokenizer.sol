...
abstract contract ICarbonTokenizer {
    function getVintageTokenIdByTokenId(uint256 tokenId) external view virtual returns (uint256);

    function getVintageBatchByTokenId(uint256 tokenId) public view virtual returns (batchTokenized memory);

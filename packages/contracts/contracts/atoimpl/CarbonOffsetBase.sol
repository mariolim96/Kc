...
// abstract contract ToucanCarbonOffsetsBase is ERC20Upgradeable, ToucanCarbonOffsetsStorage {
//     // ----------------------------------------
//     //              Constants
//     // ----------------------------------------
...
//         address tco2Factory = IToucanContractRegistry(contractRegistry).toucanCarbonOffsetsFactoryAddress(
//             standardRegistry()
//         );
...
//             standardRegistry()
//         );
//         bool isAllowed = IToucanCarbonOffsetsFactory(tco2Factory).allowedBridges(msg.sender);
...
//     modifier onlyEscrow() {
//         require(
//             IToucanContractRegistry(contractRegistry).toucanCarbonOffsetsEscrowAddress() == msg.sender,
//             'Not escrow contract'
//         );
//         _;
//     }
...
//         return string(abi.encodePacked('Toucan Protocol: TCO2-', globalProjectId, '-', vintageName));
//     }
...
//         string memory vintageName;
//         (globalProjectId, vintageName) = getGlobalProjectVintageIdentifiers();
//         return string(abi.encodePacked('TCO2-', globalProjectId, '-', vintageName));
//     }
...
//         address pc = IToucanContractRegistry(contractRegistry).carbonProjectsAddress();
//         address vc = IToucanContractRegistry(contractRegistry).carbonProjectVintagesAddress();

//         VintageData memory vintageData = ICarbonProjectVintages(vc).getProjectVintageDataByTokenId(
...
//         address certAddr = IToucanContractRegistry(contractRegistry).retirementCertificatesAddress();
...
//         IRetirementCertificates(IToucanContractRegistry(contractRegistry).retirementCertificatesAddress())
